        ...
        <>
            ...
            <form>
                <div class="mb-3">
                    ...
                    <input type="name" name='username' value={user.username} onChange={handleChange} class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name='confirm' value={user.confirm} onChange={handleChange} class="form-control" id="exampleInputPassword1" />
